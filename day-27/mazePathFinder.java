...
public class MazePathFinder {
    ...
    private static void findPathInMazeUtil(int[][] maze, ArrayList<int[]> path,
        ...
        for (int i = 0; i < 4; i++) {
            ...
            if (isValid(visited, next)) {
                ...
                visited.removeIf(item -> item[0] == next[0]
                        && item[1] == next[1]);
            }
        }
    }
    ...
    public static void findPathInMaze(int[][] maze) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            path.remove(path.size() - 1);
            visited.removeIf(item -> item[0] == pt[0]
                    && item[1] == pt[1]);
        }
    }
